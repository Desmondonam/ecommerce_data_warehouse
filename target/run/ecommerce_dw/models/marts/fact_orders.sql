    ...
    create  table
      "warehouse"."marts_marts"."fact_orders__dbt_tmp"
...
order_items as (
    select * from "warehouse"."marts_staging"."stg_order_items"
),

customers as (
    select * from "warehouse"."marts_staging"."stg_customers"
),

sellers as (
    select * from "warehouse"."marts_staging"."stg_sellers"
),

products as (
    select * from "warehouse"."marts_staging"."stg_products"
),
